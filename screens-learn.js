/* OTR LMS · learning screens: assignment (recorder), quiz, results, player, grades */
(function () {
  ...
  S.assignment = {
    ...
    mount(root) {
      ...
      root.querySelector('#rec-submit').addEventListener('click',(e)=>{
        ...
        setTimeout(()=>{ b.outerHTML=`<div class="alert ok"><span class="ai">${IC.checkCircle}</span><div><div class="at">¡Entregado!</div>Tu coach revisará la grabación. Recibirás feedback pronto.</div></div>`; },900);
      });
    }
  };
  ...
  S.quiz = {
    ...
    mount(root) {
      ...
      next.addEventListener('click',()=>{ if(i<QUIZ.length-1){i++;paint();} else { window.__quizAns=ans; go('quiz-results'); } });
      paint();
    }
  };
      ...
      <div class="lesson-wrap" style="grid-template-columns:1fr 300px">
        <div>
          ...
          <div class="row between vcenter" style="margin:16px 0 8px">
            <div><h2 style="font-size:19px;font-weight:750">Simulacro con jueces · Final interna</h2>
