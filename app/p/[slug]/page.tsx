...
// de contacto. Diseño claro premium (Brand Book V1.0): negro #171717 +
// naranja #F25623 como único acento, grises fríos, Inter.
...
export default async function PublicProfilePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="pp-page">
      <style>{`
        .pp-page{min-height:100vh;background:#FCFCFC;color:#171717;font-family:'Inter',system-ui,-apple-system,'Segoe UI',sans-serif;-webkit-font-smoothing:antialiased;padding-bottom:56px}
        .pp-wrap{max-width:780px;margin:0 auto;padding:0 20px}
        .pp-hero{background:radial-gradient(640px 280px at 85% -10%,rgba(242,86,35,.30),transparent 60%),linear-gradient(140deg,#171717 0%,#000000 55%,#262626 100%);padding:56px 0 78px;color:#fff}
        .pp-avatar{width:88px;height:88px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:28px;letter-spacing:1px;color:#fff;background:rgba(242,86,35,.20);border:2px solid rgba(242,86,35,.55);margin-bottom:18px}
        .pp-name{margin:0;font-size:32px;font-weight:800;letter-spacing:-.03em;color:#fff}
        .pp-sub{margin:6px 0 18px;color:#BDBDBD;font-weight:600;font-size:15px}
        .pp-hero-meta{display:flex;flex-wrap:wrap;gap:10px}
        .pp-pill{background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.16);color:#EFEFEF;border-radius:999px;padding:7px 14px;font-size:13px;font-weight:600}
        .pp-pill strong{color:#fff;font-weight:800;margin-right:6px}
        .pp-pill-pro{background:rgba(255,255,255,.18);border-color:rgba(255,255,255,.38);color:#fff}
        .pp-main{margin-top:-34px}
        .pp-card{background:#fff;border:1px solid #E7E7E7;border-radius:12px;padding:24px 26px;margin-bottom:22px;box-shadow:0 10px 30px rgba(23,23,23,.05)}
        .pp-h2{margin:0 0 16px;font-size:13px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:#4D4D4D}
        ...
        .pp-skill-n{color:#171717;font-weight:800}
        .pp-bar{height:8px;border-radius:999px;background:#EFEFEF;overflow:hidden}
        .pp-bar-fill{height:100%;border-radius:999px;background:linear-gradient(90deg,#F25623,#C8401A)}
        .pp-stats{display:grid;grid-template-columns:repeat(auto-fit,minmax(120px,1fr));gap:12px}
        .pp-stat{background:#FCFCFC;border:1px solid #E7E7E7;border-radius:12px;padding:16px 12px;text-align:center}
        .pp-stat-n{font-size:26px;font-weight:800;color:#171717}
        .pp-stat-l{font-size:12px;font-weight:600;color:#4D4D4D;margin-top:2px}
        .pp-rating-row{display:flex;flex-wrap:wrap;gap:8px;margin-top:16px}
        .pp-rating-chip{font-size:12px;font-weight:600;color:#4D4D4D;background:#FCFCFC;border:1px solid #E7E7E7;border-radius:999px;padding:5px 11px}
        .pp-cred{display:flex;justify-content:space-between;align-items:baseline;gap:14px;padding:13px 0;border-bottom:1px solid #EFEFEF}
        .pp-cred:last-child{border-bottom:0}
        .pp-cred-t{font-size:15px;font-weight:700}
        .pp-cred-d{font-size:13px;color:#4D4D4D;font-weight:500;white-space:nowrap}
        .pp-timeline{list-style:none;margin:0;padding:0;position:relative}
        .pp-timeline:before{content:"";position:absolute;left:5px;top:6px;bottom:6px;width:2px;background:#FDE7DE;border-radius:2px}
        .pp-tl-item{position:relative;padding:0 0 22px 26px}
        .pp-tl-item:last-child{padding-bottom:0}
        .pp-tl-dot{position:absolute;left:0;top:4px;width:12px;height:12px;border-radius:50%;background:#171717;border:2px solid #fff;box-shadow:0 0 0 2px #FDE7DE}
        .pp-tl-date{font-size:12px;font-weight:700;color:#8C8C8C;text-transform:uppercase;letter-spacing:.06em}
        .pp-tl-title{margin:2px 0 0;font-size:15px;font-weight:700;color:#171717}
        .pp-tl-detail{margin:2px 0 0;font-size:13.5px;color:#4D4D4D;line-height:1.5}
        .pp-empty{margin:0;font-size:14px;color:#4D4D4D}
        .pp-footer{margin-top:8px;text-align:center;font-size:13px;font-weight:600;color:#4D4D4D}
