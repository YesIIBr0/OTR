...
declare global {
  interface Window {
    ...
    // otrGetLang ya lo declara app/lib/i18n.ts con el tipo preciso (typeof getLang) —
    // declararlo aquí también con una forma más laxa (() => string) choca con TS2717
    // (una interfaz global no puede tener dos formas distintas para la misma propiedad).
    refresh?: () => void;
