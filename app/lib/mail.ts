...
/** Escape mínimo de HTML para contenido dinámico embebido en templates de correo
    (no todos los call-sites tienen a mano app/lib/esc, que es de uso server-side
    general; este es local a mail.ts para no crear un ciclo de imports). */
