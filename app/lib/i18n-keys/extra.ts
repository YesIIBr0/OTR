export const dict = {
  ...
  en: {
    ...
    "extra.reassignAria": "Reassign the owner of {course}",
    "extra.reassignTitle": "Reassign owner · {course}",
    "extra.reassignField": "New owner",
    "extra.reassignOk": "Course owner updated",
    "extra.reassignNoCoaches": "There are no coaches to assign this course to",
    "extra.reassignLoadFail": "Could not load the list of coaches",
    "extra.draft": "Draft",
