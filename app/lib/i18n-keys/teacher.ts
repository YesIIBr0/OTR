...
export const dict = {
  es: {
    ...
    "teacher.win": "Ganó",
    "teacher.loss": "Perdió",
    "teacher.debateQueueTitle": "Solicitudes de debate",
    "teacher.debateQueueSub": "Pendientes de tu aprobación — al aprobar, mueven el rating del alumno.",
    "teacher.approve": "Aprobar",
    "teacher.approving": "Aprobando…",
    "teacher.approved": "Solicitud aprobada",
    "teacher.promotedTo": " · ¡{tier}!",
    "teacher.reject": "Rechazar",
    "teacher.rejecting": "Rechazando…",
    "teacher.rejected": "Solicitud rechazada",
    "teacher.rejectTitle": "Rechazar solicitud",
    "teacher.rejectReasonLabel": "Motivo (lo verá el alumno)",
    "teacher.rejectReasonPh": "Ej. faltan datos del torneo…",
    "teacher.queueError": "No se pudo procesar la solicitud",
  ...
  en: {
    ...
    "teacher.win": "Won",
    "teacher.loss": "Lost",
    "teacher.debateQueueTitle": "Debate requests",
    "teacher.debateQueueSub": "Awaiting your approval — approving moves the student's rating.",
    "teacher.approve": "Approve",
    "teacher.approving": "Approving…",
    "teacher.approved": "Request approved",
    "teacher.promotedTo": " · {tier}!",
    "teacher.reject": "Reject",
    "teacher.rejecting": "Rejecting…",
    "teacher.rejected": "Request rejected",
    "teacher.rejectTitle": "Reject request",
    "teacher.rejectReasonLabel": "Reason (the student will see it)",
    "teacher.rejectReasonPh": "e.g. missing tournament details…",
    "teacher.queueError": "Couldn't process the request",
