...
export const dict = {
  es: {
    ...
    "lifetime.memProFeat1": "Sello OTR Pro en tu perfil y en el leaderboard",
    "lifetime.memProFeat2": "Tu trayectoria destacada: perfil público y credenciales compartibles",
  ...
  en: {
    ...
    "lifetime.memProFeat1": "OTR Pro badge on your profile and the leaderboard",
    "lifetime.memProFeat2": "Your journey, featured: public profile and shareable credentials",
