...
export const dict = {
  es: {
    ...
    "apierr.passwordShort": "La contraseña debe tener al menos 8 caracteres",
    "apierr.passwordCommon": "Esa contraseña es demasiado común — elige otra más difícil de adivinar",
  ...
  en: {
    ...
    "apierr.passwordShort": "Password must be at least 8 characters",
    "apierr.passwordCommon": "That password is too common — pick one that is harder to guess",
