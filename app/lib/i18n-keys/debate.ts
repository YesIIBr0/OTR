...
export const dict = {
  es: {
    ...
    "debate.statusPending": "Pendiente",
    "debate.statusRejected": "Rechazada",
    "debate.rejectionPrefix": "Motivo",
  ...
  en: {
    ...
    "debate.statusPending": "Pending",
    "debate.statusRejected": "Rejected",
    "debate.rejectionPrefix": "Reason",
