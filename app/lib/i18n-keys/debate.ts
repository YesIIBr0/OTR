...
export const dict = {
  es: {
    ...
    "debate.kpiDrawsLosses": "Empates · derrotas",
    "debate.recentDebates": "Debates recientes",
    "debate.seeAll": "Ver todos",
    "debate.historyEmpty": "Historial en cero. Juega una práctica o registra tu primera ronda.",
    ...
    "debate.practiceSub": "Cronometra un flujo PF completo y registra el resultado. La práctica queda en tu historial; tu rating solo se mueve en rondas adjudicadas por un coach.",

    // leaderboard
    "debate.lbEmptyTitle": "Entra en la clasificación",
    "debate.lbEmptyBody": "Juega rondas adjudicadas y reclama tu posición antes que el resto del cohort.",
    ...
    "debate.anNoDataBody": "Juega rondas adjudicadas para ver tu desglose por formato y lado.",
  ...
  en: {
    ...
    "debate.kpiDrawsLosses": "Draws · losses",
    ...
    "debate.practiceSub": "Time a full PF flow and record the result. Practice stays in your history; your rating only moves on rounds adjudicated by a coach.",

    // leaderboard
    "debate.lbEmptyTitle": "Join the standings",
    "debate.lbEmptyBody": "Play adjudicated rounds and claim your spot before the rest of the cohort.",
    ...
    "debate.anNoDataBody": "Play adjudicated rounds to see your breakdown by format and side.",
